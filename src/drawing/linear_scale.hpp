...
private:
    ...
    bool m_clampEnabled;
public:
    ScaleLinear(double domainMin, double domainMax, double rangeMin, double rangeMax, bool clamp = false) 
        : m_domainMin(domainMin), m_domainMax(domainMax), m_rangeMin(rangeMin), m_rangeMax(rangeMax), m_clampEnabled(clamp) 
    {
